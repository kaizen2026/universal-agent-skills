...
The issue tracker and triage label vocabulary should have been provided to you — run `/setup-universal-agent-skills` if not.
...
Publish the approved tickets. **How** depends on the tracker `/setup-universal-agent-skills` configured — the tickets are the same either way, only the shape of the blocking edges changes:
