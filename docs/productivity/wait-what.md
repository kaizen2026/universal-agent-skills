...
If the repository has several glossaries, the skill follows `CONTEXT-MAP.md` to the relevant `CONTEXT.md`. If you have no glossary, the skill still works. You lose only the domain-vocabulary half.
