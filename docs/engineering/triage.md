...
The deprecated upstream setup did not create labels in the tracker ([upstream issue #616](https://github.com/mattpocock/skills/issues/616)). `setup-universal-agent-skills` keeps label creation explicit: create the state and category labels with the tracker's CLI or UI when they do not exist.
